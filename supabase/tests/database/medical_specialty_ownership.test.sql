...
select extensions.has_table('public', 'medical_specialty_owners', 'specialty ownership exists');
select extensions.has_table('public', 'competency_specialties', 'competency specialty links exist');
