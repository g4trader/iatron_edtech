...
export async function finishAssessment(id:string){const response=await request(`/${id}/finish`,{method:'POST'});if(!response.ok)throw new Error('Não foi possível concluir o diagnóstico.');}
